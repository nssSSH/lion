...
- Java
- TypeScript
(Planned support for Zig, Gleam and more coming soon!)


### Documentation

See the [Docs](https://github.com/unsecretised/lion/blob/main/DOCS.md) for detailed usage.

### Contributing

Want to help make Lion more awesome by contributing? Please check out [Contributing](https://github.com/unsecretised/lion/blob/main/DOCS.md) and make a PR right away!
